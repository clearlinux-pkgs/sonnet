...
Source0  : https://download.kde.org/stable/frameworks/5.102/sonnet-5.102.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.102/sonnet-5.102.0.tar.xz.sig
...
%prep
%setup -q -n sonnet-5.102.0
cd %{_builddir}/sonnet-5.102.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673888583
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5SonnetCore.so.5.102.0
/usr/lib64/libKF5SonnetUi.so.5
/usr/lib64/libKF5SonnetUi.so.5.102.0
