...
Version  : 6.12.0
Release  : 93
URL      : https://download.kde.org/stable/frameworks/6.12/sonnet-6.12.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.12/sonnet-6.12.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.12/sonnet-6.12.0.tar.xz.sig
...
%setup -q -n sonnet-6.12.0
cd %{_builddir}/sonnet-6.12.0
pushd ..
cp -a sonnet-6.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742475932
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6SonnetCore.so.6.12.0
/V3/usr/lib64/libKF6SonnetUi.so.6.12.0
...
/usr/lib64/libKF6SonnetCore.so.6.12.0
/usr/lib64/libKF6SonnetUi.so.6
/usr/lib64/libKF6SonnetUi.so.6.12.0
