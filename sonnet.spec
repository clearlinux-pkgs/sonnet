...
Source0  : https://download.kde.org/stable/frameworks/5.61/sonnet-5.61.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.61/sonnet-5.61.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565589519
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5SonnetCore.so.5.61.0
/usr/lib64/libKF5SonnetUi.so.5
/usr/lib64/libKF5SonnetUi.so.5.61.0
