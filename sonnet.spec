...
Source0  : https://download.kde.org/stable/frameworks/5.62/sonnet-5.62.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.62/sonnet-5.62.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568913344
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5SonnetCore.so.5.62.0
/usr/lib64/libKF5SonnetUi.so.5
/usr/lib64/libKF5SonnetUi.so.5.62.0
