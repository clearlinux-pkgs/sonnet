...
Source0  : https://download.kde.org/stable/frameworks/5.89/sonnet-5.89.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.89/sonnet-5.89.0.tar.xz.sig
...
%prep
%setup -q -n sonnet-5.89.0
cd %{_builddir}/sonnet-5.89.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639672166
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/sonnet-5.89.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/sonnet/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/sonnet-5.89.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/sonnet/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/sonnet-5.89.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/sonnet/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/sonnet-5.89.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/sonnet/6f1f675aa5f6a2bbaa573b8343044b166be28399
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5SonnetCore.so.5.89.0
/usr/lib64/libKF5SonnetUi.so.5
/usr/lib64/libKF5SonnetUi.so.5.89.0
