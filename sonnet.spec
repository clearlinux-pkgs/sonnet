...
Source0  : https://download.kde.org/stable/frameworks/5.114/sonnet-5.114.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.114/sonnet-5.114.0.tar.xz.sig
...
%prep
%setup -q -n sonnet-5.114.0
cd %{_builddir}/sonnet-5.114.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705442944
mkdir -p clr-build
pushd clr-build
...
%files bin
%defattr(-,root,root,-)
/V3/usr/bin/gentrigrams
/V3/usr/bin/parsetrigrams
/usr/bin/gentrigrams
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5SonnetCore.so.5.114.0
/V3/usr/lib64/libKF5SonnetUi.so.5.114.0
/V3/usr/lib64/qt5/plugins/designer/sonnetui5widgets.so
/V3/usr/lib64/qt5/plugins/kf5/sonnet/sonnet_aspell.so
/V3/usr/lib64/qt5/plugins/kf5/sonnet/sonnet_hunspell.so
/V3/usr/lib64/qt5/qml/org/kde/sonnet/libsonnetquickplugin.so
/usr/lib64/libKF5SonnetCore.so.5
/usr/lib64/libKF5SonnetCore.so.5.114.0
/usr/lib64/libKF5SonnetUi.so.5
/usr/lib64/libKF5SonnetUi.so.5.114.0
